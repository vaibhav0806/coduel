...
('python', 1, 'variables', 'basics', E'a = 1
b = 2
a, b = b, a
...
('python', 1, 'booleans', 'basics', E'print(not False)', 'What''s the output?', $$["True", "False", "None", "Error"]$$::jsonb, 0, E'not inverts the boolean value. not False = True.'),
...
('python', 1, 'arithmetic', 'basics', E'print(2 ** 3)', 'What''s the output?', $$["6", "8", "9", "Error"]$$::jsonb, 1, E'** is the exponent operator. 2 ** 3 = 2 * 2 * 2 = 8.'),
('python', 1, 'types', 'basics', E'x = 5.0
...
('python', 1, 'arithmetic', 'basics', E'print(abs(-7))', 'What''s the output?', $$["7", "-7", "0", "Error"]$$::jsonb, 0, E'abs() returns the absolute value. abs(-7) = 7.'),
('python', 1, 'booleans', 'basics', E'print(10 == 10.0)', 'What''s the output?', $$["True", "False", "Error", "None"]$$::jsonb, 0, E'Python considers 10 and 10.0 equal when using ==.'),
...
('python', 2, 'functions', 'functions', E'def greet(name="World"):
    return f"Hello, {name}!"
...
('python', 2, 'strings', 'strings', E'x = "Python"
...
('python', 2, 'dictionaries', 'collections', E'x = {}
x["a"] = 1
x["b"] = 2
x["a"] = 3
...
('python', 2, 'loops', 'control-flow', E'x = "abcd"
result = ""
for c in x:
    result = c + result
...
('python', 3, 'closures', 'functions', E'def outer():
    x = 10
    def inner():
        return x
    x = 20
...
('python', 3, 'lists', 'collections', E'x = [1, [2, 3]]
y = x.copy()
y[1].append(4)
...
('python', 3, 'comprehensions', 'control-flow', E'x = [i for i in range(10) if i % 3 == 0]
...
('python', 3, 'decorators', 'decorators', E'def double(func):
    def wrapper(*args):
        return func(*args) * 2
    return wrapper
...
('python', 3, 'generators', 'iterators', E'def fib():
    a, b = 0, 1
    while True:
        yield a
        a, b = b, a + b
...
('python', 3, 'dictionaries', 'collections', E'x = {"a": 1, "b": 2}
y = {"b": 3, "c": 4}
z = {**x, **y}
...
('python', 3, 'itertools', 'iterators', E'from itertools import chain
x = [1, 2]
y = [3, 4]
...
('python', 3, 'lambda', 'functions', E'ops = [lambda x, i=i: x + i for i in range(3)]
...
('python', 3, 'comprehensions', 'control-flow', E'matrix = [[1,2],[3,4],[5,6]]
...
('python', 3, 'walrus', 'modern', E'data = [1, 2, 3, 4, 5, 6]
...
('python', 3, 'unpacking', 'modern', E'first, *middle, last = [1, 2, 3, 4, 5]
...
('python', 3, 'strings', 'strings', E'import re
x = "abc123def456"
...
('python', 3, 'scope', 'functions', E'x = [1, 2, 3]
def foo():
    x.append(4)
foo()
...
('python', 4, 'metaclasses', 'modern', E'class Meta(type):
...
('python', 4, 'descriptors', 'modern', E'class Desc:
...
('python', 4, 'closures', 'functions', E'funcs = []
for i in range(3):
...
('python', 4, 'decorators', 'decorators', E'def repeat(n):
    def decorator(func):
        def wrapper(*args):
...
('python', 4, 'context', 'decorators', E'class CM:
    def __enter__(self):
        print("enter", end=" ")
        return self
...
('python', 4, 'iterators', 'iterators', E'class Count:
    def __init__(self, n):
        self.n = n
    def __iter__(self):
        self.i = 0
...
('python', 4, 'scope', 'functions', E'def make_counter():
    count = 0
    def inc():
        nonlocal count
        count += 1
...
('python', 4, 'slots', 'oop', E'class Foo:
    __slots__ = ("x",)
    def __init__(self):
        self.x = 1
f = Foo()
...
('python', 4, 'dataclasses', 'modern', E'from dataclasses import dataclass, field
...
('python', 4, 'typing', 'modern', E'from typing import TypeVar, Generic
T = TypeVar("T")
...
('python', 4, 'hashing', 'modern', E'x = {True: "yes", 1: "one", 1.0: "float"}
...
('python', 4, 'functions', 'functions', E'def foo():
    try:
        return 1
    finally:
        return 2
...
('python', 4, 'classes', 'oop', E'class A:
...
('python', 4, 'walrus', 'modern', E'import re
...
('python', 4, 'itertools', 'iterators', E'from itertools import groupby
data = [1, 1, 2, 2, 2, 3]
...
('python', 4, 'unpacking', 'modern', E'def foo(**kw):
